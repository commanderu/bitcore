...
TransactionBuilder.infoForP2sh = function(opts, networkName) {
  ...
  var version = networkName === 'cdrtestnet' ?
    networks.cdrtestnet.P2SHVersion : networks.cdrlivenet.P2SHVersion;
...
TransactionBuilder.prototype._multiFindKey = function(walletKeyMap, pubKeyHash) {
  var wk;
  [networks.cdrlivenet, networks.cdrtestnet].forEach(function(n) {
