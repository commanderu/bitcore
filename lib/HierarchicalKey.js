...
var HierarchicalKey = function(bytes) {
  if (typeof bytes == 'undefined' || bytes == 'mainnet' || bytes == 'cdrlivenet') {
    bytes = 'cdrlivenet';
    this.version = networks['cdrlivenet'].hkeyPrivateVersion;
  } else if (bytes == 'cdrtestnet') {
    this.version = networks['cdrtestnet'].hkeyPrivateVersion;
  }
  if (bytes == 'cdrlivenet' || bytes == 'cdrtestnet') {
    this.depth = 0x00;
...
HierarchicalKey.prototype.initFromBytes = function(bytes) {
  ...
  var isPublic =
    (this.version == networks['cdrlivenet'].hkeyPublicVersion ||
      this.version == networks['cdrtestnet'].hkeyPublicVersion);
...
HierarchicalKey.prototype.buildExtendedPublicKey = function() {
  ...
  var v = null;
  switch (this.version) {
    case networks['cdrlivenet'].hkeyPublicVersion:
    case networks['cdrlivenet'].hkeyPrivateVersion:
      v = networks['cdrlivenet'].hkeyPublicVersion;
      break;
    case networks['cdrtestnet'].hkeyPublicVersion:
    case networks['cdrtestnet'].hkeyPrivateVersion:
      v = networks['cdrtestnet'].hkeyPublicVersion;
      break;
    default:
